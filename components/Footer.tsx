      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Your official destination for Ghana Black Stars jerseys. Support the national team with authentic gear.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            ...
            <li>✉️ hello@ghanajerseystore.com</li>
          </ul>
        </div>
      </div>

      <div className="border-t border-gray-800 text-center text-xs text-gray-500 py-4">
        © {new Date().getFullYear()} Ghana Jersey Store. All rights reserved. | Go Black Stars! 🌟
      </div>
    </footer>
  );
}
